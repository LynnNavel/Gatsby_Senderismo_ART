...
import reservacss from "../styles/reservar.css";
import calendariocss from "../styles/calendario.css";

export default (props) => (

    <div class="padre_body_reservar">

        <Helmet>

        <link rel="stylesheet" href={formulariocss}/>
        <link rel="stylesheet" href={calendariocss}/>
        <link rel="stylesheet" href={reservacss}/>
